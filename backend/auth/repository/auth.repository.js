...
class AuthRepository{
    ...
    static refreshTokenCreateRepo=async(tx,id,tokenValue,expiresAt)=>{
        await tx.query(`INSERT INTO "refreshToken" ("userId","tokenValue","expiresAt")
            VALUES ($1,$2,$3) ON CONFLICT ("userId") DO UPDATE SET
            "tokenValue"=EXCLUDED."tokenValue","expiresAt"=EXCLUDED."expiresAt" `,
            [id,tokenValue,expiresAt])
    }
}
